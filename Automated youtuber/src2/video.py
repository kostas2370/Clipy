...
def test():
        #print("kekw")
	#option - 1
	#video(game="Minecraft",amt=1,serie="minecraft Compilation",get_clips=True,mode="game",days=7)	
	#option - 2
	video(streamers="SovietWomble",amt=5,serie="sovietwombel Compilation",get_clips=False,mode="streamer",days=30)
