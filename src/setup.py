...
def db_making(clips_destination,video_destination,clips_to_delete_destination,music_destination,always_destination,prebuild_photos):
                ...
                entolh="INSERT INTO settings VALUES('{}','{}','{}','{}','{}','{}')"
                c.execute(entolh.format(clips_destination,video_destination,clips_to_delete_destination,music_destination,always_destination,prebuild_photos))
...
def mk_dirs(default):
                ...
                try:
                                ...
                                os.mkdir(default2+"always_destination")
                                os.mkdir(default2+"clips")
                                os.mkdir(default2+"clips/edited")
                                os.mkdir(default2+"video")
...
def setup(mode="default"):
                x=getpass.getuser()
                save_files="C:/users/{x}/Videos/"
                default=save_files.format(x=x)
                if(mode=="default"):
                                p=mk_dirs(default)
